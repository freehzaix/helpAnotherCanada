...
<html lang="fr">
<head>
	<title>S'inscrire - Portail du conseil d'administration</title>
	<!-- Meta tag Keywords -->
	...
	<div class="main-bg">
		...
		<div class="sub-main-w3">
			<div class="bg-content-w3pvt">
				...
				<form action="{{ route('register.conseil.post') }}" method="post">
                    @csrf
					<p class="legend">Création d'un compte</p>
					<div class="input">
				...
				<a href="{{ route('login.conseil') }}" class="bottom-text-w3ls">Se connecter maintenant.</a>
			</div>
		</div>
		<!-- //content -->
		<!-- copyright -->
